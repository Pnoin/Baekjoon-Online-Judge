...
int n,m,x;
int temp=0,ans[500005]={},presence[500005]={},v[500005]={};
vector <int> pre;
...
int main(){
	...
	for(register int i=1; i<m; i++){
		while(start<mos[i].second.first){
            presence[v[start]]--;
            if(presence[v[start]]+1==3 && presence[v[start]]==2){
                temp++;
            }
            else if(presence[v[start]]+1==2 && presence[v[start]]==1){
                temp--;
            }
            start++;
        }
		while(start>mos[i].second.first){
            start--;
            presence[v[start]]++;
            if(presence[v[start]]-1==1 && presence[v[start]]==2){
                temp++;
            }
            else if(presence[v[start]]-1==2 && presence[v[start]]==3){
                temp--;
            }
        }
		while(end<mos[i].second.second){
            ...
            presence[v[end]]++;
            if(presence[v[end]]-1==1 && presence[v[end]]==2){
                temp++;
            }
            else if(presence[v[end]]-1==2 && presence[v[end]]==3){
                temp--;
            }
        }
		while(end>mos[i].second.second){
            presence[v[end]]--;
            if(presence[v[end]]+1==3 && presence[v[end]]==2){
                temp++;
            }
            else if(presence[v[end]]+1==2 && presence[v[end]]==1){
                temp--;
            }
            end--;
        }
